...
struct effect_interface_s { int (*process)(void *, void *, void *); };
typedef struct { effect_interface_s *itfe; } mock_effect_handle_base_t;
...
static const host_effect_uuid_t HOST_IMPL_UUID = {
    0xf1a2b3c4, 0x5678, 0x90ab, 0xcdef,
    {0x01, 0x23, 0x45, 0x67, 0x89, 0xab}
};
static const host_effect_uuid_t HOST_TYPE_UUID = {
    0x7b491460, 0x8d4d, 0x11e0, 0xbd6a,
